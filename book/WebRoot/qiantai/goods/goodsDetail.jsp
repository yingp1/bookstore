...
<div id="MainCenter" align="center" class="MainCenter">
		 ...
		 <div id="content" class="Sub">
				<div class="NewContainer771">
					<div class="BoxHeader">
						<div class="BoxHeader-center MarginTop10">图书详细信息</div>
					</div>
					<div class="Slot">
						...
						<table width="100%" border="0">
						    ...
						    <tr>
						       <td align="center">图书名称：<s:property value="#request.goods.goodsName"/><hr/>作者：<s:property value="#request.goods.goodsYanse"/><hr/></td>
						    </tr>
						    <tr>
						       <td align="center">图书介绍:<s:property value="#request.goods.goodsMiaoshu" escape="false"/><hr/></td>
						    </tr>
						    <tr>
