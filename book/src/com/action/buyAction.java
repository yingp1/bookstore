...
public class buyAction extends ActionSupport
{
	...
	public String orderSubmit()
	{
		...
		String fs=order.getOdderFukuangfangshi();
	
		if(fs.equals("在线付款")){		
			int a=user.getUserOne6();
			System.out.println(a);
			int b=cart.getTotalPrice();
			a=a-b;
				user.setUserOne6(a);
				System.out.println(a);
				
				System.out.println(cart.getTotalPrice());
				System.out.println(user.getUserOne6());
	...
	public String testCart()
	{
		...
		for (Iterator it = items.values().iterator(); it.hasNext();)
		{
			...
			System.out.println(goods.getGoodsName()+"：名称");
