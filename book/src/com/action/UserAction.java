...
public class UserAction extends ActionSupport
{
	...
	public String chongzhi()
	{
		...
		int a =user.getUserOne6()+userOne6;
		
		System.out.println(userId);
		System.out.println(userOne6);
		user.setUserOne6(a);
		userDAO.attachDirty(user);
		session.put("user", user);
		return "successAdd";
	...
	/** 检测登录帐号是否有效 */
	public boolean chkLoginName(String jsonrpc) throws Exception {
		String sql="from TUser where userName='"+jsonrpc+"'";
	...
	public void setUserOne6(int userOne6){
		this.userOne6=userOne6;
		
	}
	public int getUserOne6(){
		return userOne6;
